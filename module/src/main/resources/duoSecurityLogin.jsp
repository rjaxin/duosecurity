            ...
            <div>
                <jato:content name="validContent">
                    <auth:form name="Login" method="post" defaultCommandChild="DefaultLoginURL">
                        <input type="hidden" name="Login.Submit" onclick="defaultSubmit(); return false;" value="" />
...
<span style="color:blue; background-color:yellow; border:5px dashed; padding:2px; font-size:26pt">Please approve this login on your Duo Mobile</span>
            </div>
<script type="text/javascript">
